...
public class CreateCloudStorageSinkAnnotationUtil extends PersonalDataAPIAnnotationUtil {
    @Override
    public AnnotationSpeculation[] createAnnotationInferences(PsiElement source) {
        ...
        annotationHolder.put(fieldDataTransmissionCollectionAttributeList,
                new ArrayList<>(
                        List.of(new String[]{"collectionAttribute.TransmittedOffDevice.True",
                                "collectionAttribute.NotStoredInBackend.False"}))
                );
