...
public class StartActivityToSendDataAnnotationUtil extends IntentBaseAnnotationUtil {
    public StartActivityToSendDataAnnotationUtil(int intentPosition) {
    ...
    public AnnotationSpeculation[] createAnnotationInferences(PsiElement source) {
        ...
        for(String statement : statements) {
            if (statement.contains("ACTION_SEND") || statement.contains("ACTION_SENDTO") ||
                    statement.contains("ACTION_SEND_MULTIPLE")) {
