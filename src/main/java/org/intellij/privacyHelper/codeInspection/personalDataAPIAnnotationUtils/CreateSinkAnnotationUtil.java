...
public class CreateSinkAnnotationUtil extends PersonalDataAPIAnnotationUtil {

    @Override
    public AnnotationSpeculation[] createAnnotationInferences(PsiElement codeElement) {
